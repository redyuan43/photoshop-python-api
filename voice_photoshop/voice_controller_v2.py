...
class VoiceController:
    ...
    def _extract_params(self, text: str, action_name: str):
        """提取参数"""
        params = {}
    ...
    def execute_api(self, action_name: str, params: dict):
        """执行API调用"""
    ...
    def _api_smart_sharpen(self, params):
        ...
        with Session() as ps:
            ...
            return f"Smart Sharpen completed"
